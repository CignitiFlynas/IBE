...
public class TC80_UAE_TI_oneWayLight1AdultnaSmiles extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC80_UAE_TI_oneWayLight1AdultnaSmiles(String tripType, String origin, String dest, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC80_UAE_TI_oneWayLight1AdultnaSmiles","Pass");
			Reporter.SuccessReport("TC80_UAE_TI_oneWayLight1AdultnaSmiles", "Pass");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC80_UAE_TI_oneWayLight1AdultnaSmiles","Fail");
			Reporter.SuccessReport("TC80_UAE_TI_oneWayLight1AdultnaSmiles", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate TI for UAE One way Light bundle 1 Adult nasmiles booking"}};
	}
