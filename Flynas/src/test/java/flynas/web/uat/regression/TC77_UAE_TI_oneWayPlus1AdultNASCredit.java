...
public class TC77_UAE_TI_oneWayPlus1AdultNASCredit extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC77_UAE_TI_oneWayPlus1AdultNASCredit(String tripType, 
		...
		try {
			...
			updateStatus("UAE_TI","TC77_UAE_TI_oneWayPlus1AdultNASCredit","Pass");
			Reporter.SuccessReport("TC77_UAE_TI_oneWayPlus1AdultNASCredit", "Pass");		
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("UAE_TI","TC77_UAE_TI_oneWayPlus1AdultNASCredit","Fail");
			Reporter.failureReport("TI for UAE One way Plus bundle 1 Adult NAS Credit booking", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate TI for UAE One way Plus bundle 1 Adult NAS Credit booking"
    			}
	    	};
	}
}
