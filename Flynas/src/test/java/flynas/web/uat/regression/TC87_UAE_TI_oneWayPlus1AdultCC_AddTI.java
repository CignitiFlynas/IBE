...
public class TC87_UAE_TI_oneWayPlus1AdultCC_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC87_UAE_TI_oneWayPlus1AdultCC_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC87_UAE_TI_oneWayPlus1AdultCC_AddTI","Pass");
			Reporter.SuccessReport("TC87_UAE_TI_oneWayPlus1AdultCC_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC87_UAE_TI_oneWayPlus1AdultCC_AddTI","Fail");
			Reporter.failureReport("TC87_UAE_TI_oneWayPlus1AdultCC_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Plus bundle 1 Adult CC booking"
    			}
	    	};
	}
}
