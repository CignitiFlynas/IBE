...
public class TC83_UAE_TI_oneWayBusiness1AdultnaSmiles extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC83_UAE_TI_oneWayBusiness1AdultnaSmiles(String tripType, String origin, String dest, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC83_UAE_TI_oneWayBusiness1AdultnaSmiles","Pass");
			Reporter.SuccessReport("TC83_UAE_TI_oneWayBusiness1AdultnaSmiles", "Pass");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC83_UAE_TI_oneWayBusiness1AdultnaSmiles","Fail");
			Reporter.SuccessReport("TC83_UAE_TI_oneWayBusiness1AdultnaSmiles", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate TI for UAE One way Business class 1 Adult nasmiles booking"}};
	}
