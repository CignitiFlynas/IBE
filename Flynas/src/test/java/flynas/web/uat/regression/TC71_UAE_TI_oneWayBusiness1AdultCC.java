...
public class TC71_UAE_TI_oneWayBusiness1AdultCC extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC71_UAE_TI_oneWayBusiness1AdultCC2(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC71_UAE_TI_oneWayBusiness1AdultCC","Pass");
			Reporter.SuccessReport("TC71_UAE_TI_oneWayBusiness1AdultCC", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC71_UAE_TI_oneWayBusiness1AdultCC","Fail");
			Reporter.failureReport("TC71_UAE_TI_oneWayBusiness1AdultCC", "Failed");
		}
	}
