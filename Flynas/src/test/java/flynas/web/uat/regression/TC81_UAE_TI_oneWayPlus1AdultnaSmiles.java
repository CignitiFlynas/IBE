...
public class TC81_UAE_TI_oneWayPlus1AdultnaSmiles extends BookingPageFlow{
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC81_UAE_TI_oneWayPlus1AdultnaSmiles(String tripType, String origin, String dest, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC81_UAE_TI_oneWayPlus1AdultnaSmiles","Pass");
			Reporter.SuccessReport("TC81_UAE_TI_oneWayPlus1AdultnaSmiles", "Pass");
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC81_UAE_TI_oneWayPlus1AdultnaSmiles","Fail");
			Reporter.SuccessReport("TC81_UAE_TI_oneWayPlus1AdultnaSmiles", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate TI for UAE One way Plus bundle 1 Adult nasmiles booking"}};
	}
