...
public class TC94_UAE_TI_oneWayLight1AdultNasmiles_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC94_UAE_TI_oneWayLight1AdultNasmiles_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC94_UAE_TI_oneWayLight1AdultNasmiles_AddTI","Pass");
			Reporter.SuccessReport("TC94_UAE_TI_oneWayLight1AdultNasmiles_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC94_UAE_TI_oneWayLight1AdultNasmiles_AddTI","Fail");
			Reporter.failureReport("TC94_UAE_TI_oneWayLight1AdultNasmiles_AddTI", "Failed");
		}
	}
