...
public class TC92_UAE_TI_oneWayPremium1AdultSadadAccount_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC92_UAE_TI_oneWayPremium1AdultSadadAccount_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC92_UAE_TI_oneWayPremium1AdultSadadAccount_AddTI","Pass");
			Reporter.SuccessReport("TC92_UAE_TI_oneWayPremium1AdultSadadAccount_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC92_UAE_TI_oneWayPremium1AdultSadadAccount_AddTI","Fail");
			Reporter.failureReport("TC92_UAE_TI_oneWayPremium1AdultSadadAccount_AddTI", "Failed");
		}
	}
