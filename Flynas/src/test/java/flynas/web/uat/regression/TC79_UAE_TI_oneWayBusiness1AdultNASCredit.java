...
public class TC79_UAE_TI_oneWayBusiness1AdultNASCredit extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC79_UAE_TI_oneWayBusiness1AdultNASCredit(String tripType, 
			...
			updateStatus("UAE_TI","TC79_UAE_TI_oneWayBusiness1AdultNASCredit","Pass");
			Reporter.SuccessReport("TC79_UAE_TI_oneWayBusiness1AdultNASCredit", "Pass");		
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("UAE_TI","TC79_UAE_TI_oneWayBusiness1AdultNASCredit","Fail");
			Reporter.failureReport("TI for UAE One way Business Class 1 Adult NAS Credit booking", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate TI for UAE One way Business class 1 Adult NASCredit booking"
    			}
	    	};
	}
}
