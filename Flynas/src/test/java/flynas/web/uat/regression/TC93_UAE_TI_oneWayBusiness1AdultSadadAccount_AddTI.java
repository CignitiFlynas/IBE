...
public class TC93_UAE_TI_oneWayBusiness1AdultSadadAccount_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC93_UAE_TI_oneWayBusiness1AdultSadadAccount_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC93_UAE_TI_oneWayBusiness1AdultSadadAccount_AddTI","Pass");
			Reporter.SuccessReport("TC93_UAE_TI_oneWayBusiness1AdultSadadAccount_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC93_UAE_TI_oneWayBusiness1AdultSadadAccount_AddTI","Fail");
			Reporter.failureReport("TC93_UAE_TI_oneWayBusiness1AdultSadadAccount_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
	    			...
	    			xls.getCellValue("Payment Type2", "Value2"),	
		    		"Validate Add TI through MMB for UAE One way Premium bundle 1 Adult SADAD Account booking"
    			}
	    	};
	}
}
