...
public class TC78_UAE_TI_oneWayPremium1AdultNASCredit extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC78_UAE_TI_oneWayPremium1AdultNASCredit(String tripType, 
...
try {
			...
			updateStatus("UAE_TI","TC78_UAE_TI_oneWayPremium1AdultNASCredit","Pass");
			Reporter.SuccessReport("TC78_UAE_TI_oneWayPremium1AdultNASCredit", "Pass");		
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("UAE_TI","TC78_UAE_TI_oneWayPremium1AdultNASCredit","Fail");
			Reporter.failureReport("TI for UAE One way Premium bundle 1 Adult NAS Credit booking", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate TI for UAE One way Premium bundle 1 Adult NAS Credit booking"
    			}
	    	};
	}
}
