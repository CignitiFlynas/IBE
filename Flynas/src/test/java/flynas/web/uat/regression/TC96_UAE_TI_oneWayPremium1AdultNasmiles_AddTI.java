...
public class TC96_UAE_TI_oneWayPremium1AdultNasmiles_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC96_UAE_TI_oneWayPremium1AdultNasmiles_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC96_UAE_TI_oneWayPremium1AdultNasmiles_AddTI","Pass");
			Reporter.SuccessReport("TC96_UAE_TI_oneWayPremium1AdultNasmiles_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC96_UAE_TI_oneWayPremium1AdultNasmiles_AddTI","Fail");
			Reporter.failureReport("TC96_UAE_TI_oneWayPremium1AdultNasmiles_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Premium bundle 1 Adult nasmiles booking"
    			}
	    	};
	}
}
