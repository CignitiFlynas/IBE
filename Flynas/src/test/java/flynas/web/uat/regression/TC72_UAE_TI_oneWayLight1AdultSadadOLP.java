...
public class TC72_UAE_TI_oneWayLight1AdultSadadOLP extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC72_UAE_TI_oneWayLight1AdultSadadOLP(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC72_UAE_TI_oneWayLight1AdultSadadOLP","Pass");
			Reporter.SuccessReport("TC72_UAE_TI_oneWayLight1AdultSadadOLP", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC72_UAE_TI_oneWayLight1AdultSadadOLP","Fail");
			Reporter.failureReport("TC72_UAE_TI_oneWayLight1AdultSadadOLP", "Failed");
		}
	}
