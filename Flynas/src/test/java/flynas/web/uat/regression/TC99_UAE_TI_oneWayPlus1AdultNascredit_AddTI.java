...
public class TC99_UAE_TI_oneWayPlus1AdultNascredit_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC99_UAE_TI_oneWayPlus1AdultNascredit_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC99_UAE_TI_oneWayPlus1AdultNascredit_AddTI","Pass");
			Reporter.SuccessReport("TC99_UAE_TI_oneWayPlus1AdultNascredit_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC99_UAE_TI_oneWayPlus1AdultNascredit_AddTI","Fail");
			Reporter.failureReport("TC99_UAE_TI_oneWayPlus1AdultNascredit_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Plus bundle 1 Adult NASCredit booking"
    			}
	    	};
	}
}
