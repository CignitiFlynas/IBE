...
public class TC73_UAE_TI_oneWayPlus1AdultSadadOLP extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC73_UAE_TI_oneWayPlus1AdultSadadOLP(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC73_UAE_TI_oneWayPlus1AdultSadadOLP","Pass");
			Reporter.SuccessReport("TC73_UAE_TI_oneWayPlus1AdultSadadOLP", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC73_UAE_TI_oneWayPlus1AdultSadadOLP","Fail");
			Reporter.failureReport("TC73_UAE_TI_oneWayPlus1AdultSadadOLP", "Failed");
		}
	}
