...
public class TC98_UAE_TI_oneWayLight1AdultNascredit_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC98_UAE_TI_oneWayLight1AdultNascredit_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC98_UAE_TI_oneWayLight1AdultNascredit_AddTI","Pass");
			Reporter.SuccessReport("TC98_UAE_TI_oneWayLight1AdultNascredit_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC98_UAE_TI_oneWayLight1AdultNascredit_AddTI","Fail");
			Reporter.failureReport("TC98_UAE_TI_oneWayLight1AdultNascredit_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Light bundle 1 Adult NASCredit booking"
    			}
	    	};
	}
}
