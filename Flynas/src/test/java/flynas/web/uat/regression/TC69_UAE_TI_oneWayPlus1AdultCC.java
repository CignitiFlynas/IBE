...
public class TC69_UAE_TI_oneWayPlus1AdultCC extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC69_UAE_TI_oneWayPlus1AdultCC(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC69_UAE_TI_oneWayPlus1AdultCC","Pass");
			Reporter.SuccessReport("TC69_UAE_TI_oneWayPlus1AdultCC", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC69_UAE_TI_oneWayPlus1AdultCC","Fail");
			Reporter.failureReport("TC69_UAE_TI_oneWayPlus1AdultCC", "Failed");
		}
	}
