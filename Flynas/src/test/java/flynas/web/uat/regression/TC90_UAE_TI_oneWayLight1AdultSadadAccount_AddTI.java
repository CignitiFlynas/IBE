...
public class TC90_UAE_TI_oneWayLight1AdultSadadAccount_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC90_UAE_TI_oneWayLight1AdultSadadAccount_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC90_UAE_TI_oneWayLight1AdultSadadAccount_AddTI","Pass");
			Reporter.SuccessReport("TC90_UAE_TI_oneWayLight1AdultSadadAccount_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC90_UAE_TI_oneWayLight1AdultSadadAccount_AddTI","Fail");
			Reporter.failureReport("TC90_UAE_TI_oneWayLight1AdultSadadAccount_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Light bundle 1 Adult SADAD Account booking"
    			}
	    	};
	}
}
