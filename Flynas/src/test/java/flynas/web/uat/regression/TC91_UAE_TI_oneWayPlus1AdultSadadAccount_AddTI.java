...
public class TC91_UAE_TI_oneWayPlus1AdultSadadAccount_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC91_UAE_TI_oneWayPlus1AdultSadadAccount_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC91_UAE_TI_oneWayPlus1AdultSadadAccount_AddTI","Pass");
			Reporter.SuccessReport("TC91_UAE_TI_oneWayPlus1AdultSadadAccount_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC91_UAE_TI_oneWayPlus1AdultSadadAccount_AddTI","Fail");
			Reporter.failureReport("TC91_UAE_TI_oneWayPlus1AdultSadadAccount_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Plus bundle 1 Adult SADAD Account booking"
    			}
	    	};
	}
}
