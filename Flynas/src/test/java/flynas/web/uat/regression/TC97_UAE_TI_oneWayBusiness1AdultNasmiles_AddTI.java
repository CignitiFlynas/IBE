...
public class TC97_UAE_TI_oneWayBusiness1AdultNasmiles_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC97_UAE_TI_oneWayBusiness1AdultNasmiles_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC97_UAE_TI_oneWayBusiness1AdultNasmiles_AddTI","Pass");
			Reporter.SuccessReport("TC97_UAE_TI_oneWayBusiness1AdultNasmiles_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC97_UAE_TI_oneWayBusiness1AdultNasmiles_AddTI","Fail");
			Reporter.failureReport("TC97_UAE_TI_oneWayBusiness1AdultNasmiles_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
	    			...
	    			xls.getCellValue("Payment Type2", "Value3"),	
		    		"Validate Add TI through MMB for UAE One way Light bundle 1 Adult nasmiles booking"
    			}
	    	};
	}
}
