...
public class TC68_UAE_TI_oneWayLight1AdultCC extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC68_UAE_TI_oneWayLight1AdultCC(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC68_UAE_TI_oneWayLight1AdultCC","Pass");
			Reporter.SuccessReport("TC68_UAE_TI_oneWayLight1AdultCC", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC68_UAE_TI_oneWayLight1AdultCC","Fail");
			Reporter.failureReport("TC68_UAE_TI_oneWayLight1AdultCC", "Failed");
		}
	}
