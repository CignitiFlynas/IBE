...
public class TC88_UAE_TI_oneWayPremium1AdultCC_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC88_UAE_TI_oneWayPremium1AdultCC_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC88_UAE_TI_oneWayPremium1AdultCC_AddTI","Pass");
			Reporter.SuccessReport("TC88_UAE_TI_oneWayPremium1AdultCC_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC88_UAE_TI_oneWayPremium1AdultCC_AddTI","Fail");
			Reporter.failureReport("TC88_UAE_TI_oneWayPremium1AdultCC_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Premium bundle 1 Adult CC booking"
    			}
	    	};
	}
}
