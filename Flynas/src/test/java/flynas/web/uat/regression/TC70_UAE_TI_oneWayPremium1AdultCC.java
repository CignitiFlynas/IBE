...
public class TC70_UAE_TI_oneWayPremium1AdultCC extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC70_UAE_TI_oneWayPremium1AdultCC(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC70_UAE_TI_oneWayPremium1AdultCC","Pass");
			Reporter.SuccessReport("TC70_UAE_TI_oneWayPremium1AdultCC", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC70_UAE_TI_oneWayPremium1AdultCC","Fail");
			Reporter.failureReport("TC70_UAE_TI_oneWayPremium1AdultCC", "Failed");
		}
	}
