...
public class TC86_UAE_TI_oneWayLight1AdultCC_AddTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC86_UAE_TI_oneWayLight1AdultCC_AddTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC86_UAE_TI_oneWayLight1AdultCC_AddTI","Pass");
			Reporter.SuccessReport("TC86_UAE_TI_oneWayLight1AdultCC_AddTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC86_UAE_TI_oneWayLight1AdultCC_AddTI","Fail");
			Reporter.failureReport("TC86_UAE_TI_oneWayLight1AdultCC_AddTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Add TI through MMB for UAE One way Light bundle 1 Adult CC booking"
    			}
	    	};
	}
}
