...
public class TC84_UAE_TI_oneWayLight1AdultCC_RemoveTI extends BookingPageFlow {

	
	ExcelReader xls = new ExcelReader(configProps.getProperty("TestDataIBEUAT"),"UAE_TI");

	@Test(dataProvider = "testData",groups={"Chrome"})
	public  void TC84_UAE_TI_oneWayLight1AdultCC_RemoveTI(String tripType, 
		...
		try {
			...
			updateStatus("IBE_UAT_Reg","TC84_UAE_TI_oneWayLight1AdultCC_RemoveTI","Pass");
			Reporter.SuccessReport("TC84_UAE_TI_oneWayLight1AdultCC_RemoveTI", "Pass");
			
			}
		
	catch (Exception e) {
			e.printStackTrace();
			updateStatus("IBE_UAT_Reg","TC84_UAE_TI_oneWayLight1AdultCC_RemoveTI","Fail");
			Reporter.failureReport("TC84_UAE_TI_oneWayLight1AdultCC_RemoveTI", "Failed");
		}
	}
	    ...
	    return (Object[][]) new Object[][] { 
	    		{
		    		...
		    		"Validate Remove TI through MMB for UAE One way Light bundle 1 Adult CC booking"
    			}
	    	};
	}
}
